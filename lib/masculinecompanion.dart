...
class MaleCompanion extends StatefulWidget {
  const MaleCompanion({super.key});

  @override
  State<MaleCompanion> createState() => _MaleCompanionState();
}

class _MaleCompanionState extends State<MaleCompanion> {
